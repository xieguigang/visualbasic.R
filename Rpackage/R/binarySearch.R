#Region "Microsoft.ROpen::d26842623a6049c0ebecdeccf750a3f9, binarySearch.R"
    ...
    # \code{compares = function(a, b) a - b} #' #'And this function should generates a numeric value for indicate the object comparision result: #' #' 0: means \code{a} equals to \code{b}\cr #' 1: means \code{a} greater than \code{b} \cr #'-1: means \code{a} less than \code{b} #' #' @seealso \code{\link{binarySearch.impl.generic}} binarySearch.dataframe <- function(dataframe, find, key, compares = function(a, b) a - b) {...
